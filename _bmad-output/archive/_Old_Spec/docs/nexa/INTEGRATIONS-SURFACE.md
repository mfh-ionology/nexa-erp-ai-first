...
> See `docs/migrations/2025-11-Phase5-billing-lifecycle.md` for `Billing*` models and `UserPermission`, `UserModuleAccess`, `WorkflowDefinition`, `WorkflowInstance` etc.
