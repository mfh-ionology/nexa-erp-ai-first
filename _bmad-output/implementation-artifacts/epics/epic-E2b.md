...
This document provides the epic and story breakdown for **Epic E2b: Granular RBAC & Access Groups**, decomposing the requirements from the PRD, Architecture, API Contracts, Data Models, UX Design Specification, and the approved E2b design document into implementable stories.
...
| Story | Title | Status |
|-------|-------|--------|
| E2b.1 | Admin can view the system resource registry | backlog |
| E2b.2 | Admin can create and configure access groups with permissions | backlog |
| E2b.3 | Admin can assign access groups to users | backlog |
| E2b.4 | System enforces granular permissions on all routes | backlog |
| E2b.5 | Admin can control field-level visibility per access group | backlog |
| E2b.6 | Admin can export and import permission configurations | backlog |

All 11 FRs covered. Stories build sequentially. No future dependencies.
