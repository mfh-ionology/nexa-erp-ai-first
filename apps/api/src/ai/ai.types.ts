...
export function resolveRole(userRole: string): BriefingRole {
  ...
  if (roleUpper.includes('FINANCE') || roleUpper.includes('ACCOUNTANT') || roleUpper.includes('BOOKKEEPER')) return 'FINANCE';
  if (roleUpper.includes('SALES') || roleUpper.includes('COMMERCIAL')) return 'SALES';
  if (roleUpper.includes('HR') || roleUpper.includes('HUMAN') || roleUpper.includes('PAYROLL')) return 'HR';
  if (roleUpper.includes('WAREHOUSE') || roleUpper.includes('INVENTORY') || roleUpper.includes('STOCK')) return 'WAREHOUSE';
