...
export const templates = [
    {
        ...
        bodyHtml: wrapHtml('Invoice {{invoiceNumber}}', `<p>Dear {{customerName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Account Statement', `<p>Dear {{customerName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Quotation {{quoteNumber}}', `<p>Dear {{customerName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Order Confirmation {{orderNumber}}', `<p>Dear {{customerName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Purchase Order {{poNumber}}', `<p>Dear {{supplierName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Credit Note {{creditNoteNumber}}', `<p>Dear {{customerName}},</p>
...
{{companyName}}`,
    },
    {
        ...
        bodyHtml: wrapHtml('Payslip — {{payPeriod}}', `<p>Dear {{employeeName}},</p>
...
// ---------------------------------------------------------------------------
export async function seedEmailTemplates(prisma, userId) {
